...
interface Props {
  ...
  onViewMerged: (records: MindMapRecord[]) => Promise<void>;
}
    ...
    <div style={{ padding: 16 }}>
      <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 12 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <button
                onClick={async () => {
                    await onViewMerged(selectedRecords);
                    fetchRecords();
                }}
                style={{
                padding: "6px 12px",
          ...
          {filteredRecords.map(record => (
            <div
              ...
              style={{
                ...
                gap: 10,
                padding: "10px 12px",
                background: selected.has(record.documentId) ? "#1e3a5f" : "#0f172a",
                borderRadius: 8,
                border: `1px solid ${selected.has(record.documentId) ? "#3b82f6" : "#1e293b"}`,
                cursor: "pointer",
              }}
            >
              {/* Checkbox */}
              ...
              {/* Doc info */}
              <div style={{ flex: 1 }} onClick={() => onViewSingle(record)}>
